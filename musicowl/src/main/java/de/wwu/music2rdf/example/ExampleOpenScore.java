...
public class ExampleOpenScore {
	...
	public static void main(String[] args) {
		...
		music2rdf.setThumbnail(
				"https://www.c82.net/images/offthestaff/large/brandenburg-concerto-no-3-in-g-major-color.jpg");
		music2rdf.setScoreIdentifier("https://musescore.com/openscore/scores/5090058");
		...
		music2rdf.addResource(new ScoreResource("https://musescore.com/score/5090058/download/pdf", "Print File",
				MediaType.PDF.toString()));
		music2rdf.setScoreTitle("Brandenburg Concerto No.3-BWV 1048");
		...
		music2rdf.setThumbnail(
				"https://www.c82.net/images/offthestaff/large/symphony-no-41-in-c-major-jupiter-color.jpg");
		music2rdf.setScoreIdentifier("https://musescore.com/openscore/scores/4861738");
		music2rdf.addCollection(new Collection("https://musescore.com/openscore", "OpenScore"));
		music2rdf
		...
		music2rdf.addResource(new ScoreResource("https://musescore.com/score/4861738/download/pdf", "Print File",
				MediaType.PDF.toString()));
		music2rdf.setScoreTitle("Symphony No.41");
		music2rdf.isVerbose(false);
		...
		music2rdf.setScoreIdentifier("https://musescore.com/openscore/scores/4145221");
		music2rdf.addCollection(new Collection("https://musescore.com/openscore", "OpenScore"));
		music2rdf.addPerson(new Person("http://dbpedia.org/resource/Pjotr_Iljitsch_Tschaikowski",
				"Pyotr Ilyich Tchaikovsky", Role.COMPOSER));
		music2rdf.addPerson(new Person("https://musescore.com/user/6105546", "Mike Nelson", Role.ENCODER));
		music2rdf.addPerson(new Person("https://www.c82.net/offthestaff", "Nicholas Rougeux", Role.LIBRETTIST));
		music2rdf.addPerson(new Person("http://jimjones.de", "Jim Jones", Role.ENCODER));
		music2rdf.addResource(new ScoreResource("https://musescore.com/score/4145221/download/pdf", "Print File",
				MediaType.PDF.toString()));
		music2rdf.setScoreTitle("The Year 1812 Op.49");
		music2rdf.isVerbose(false);
		music2rdf.setOutputFormat("turtle");
